...
print('hello world')
api_endpoint = 'http://test-env.vdxd9zppmk.us-west-2.elasticbeanstalk.com/create_device' 
...
payload = {'deviceName': device_name, 'serialNumber': serial_number}
...
with open('device-certificate.pem.crt', 'w') as f:
   f.write(response_json["certs"]["certificate_pem"])
